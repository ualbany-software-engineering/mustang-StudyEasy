...
const update = (e) =>{updateData(e.value)}
  ...
  return (
    <>
    <div className='UAB'>
      <h1>Welcome to Peking University</h1>
      <div class="img"><img src="https://mcdonnell.wustl.edu/wp-content/uploads/2020/10/PKU.png"/>
      <br />
      <p>Peking University (PKU; Chinese: 北京大学; lit. 'University of Beijing'; colloquially known as Beida (北大)) is a public research university in Beijing, China. The university is funded by the Ministry of Education.</p>
      <div class="req">
