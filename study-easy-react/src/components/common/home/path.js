      ...
      <div class="scrollholder mt-4">
        <div>
          ...
          <div>
            ...
            <button className='primary-btn' data-aos="fade-left"><Link to="/Countries" style={{color: "white"}}>Checkout</Link></button>
        ...
        <div>
          <div>
            ...
            <button data-aos="fade-left"><Link to="/Countries" style={{color: "black"}}>Checkout</Link></button>
          </div>
          <div>
