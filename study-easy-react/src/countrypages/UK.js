...
export const UK = () => {
  return (
    ...
    <College collegeName="University of Cambridge" Logo='https://saltosystems.com/sites/default/files/styles/breakpoint_1920/public/images/case-studies/education-case-cambridge-00_0.jpg?itok=5JrTeXFn' zipCode={"CB21TN"} url= "https://www.cam.ac.uk/" name = "/UC"  number={1}/>
