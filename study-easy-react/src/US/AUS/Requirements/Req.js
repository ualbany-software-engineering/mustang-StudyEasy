    ...
    if (course==='CS'){
      return(
        <div>
          ...
          <h3>Required Exams:</h3> <h5>Victorian Certificate of Education, IELTS/TOEFL</h5><br></br>
    ...
    if(course==='IS'){
      return(
        <div>
          ...
          <h3>Required Exams:</h3> <h5>Victorian Certificate of Education, IELTS</h5><br></br>
